			...
			<TR>
				<TD colspan="3" nowrap="true">
					...
					<INPUT TYPE="text" name="BIG_04" size="25" maxlength="22" Class="inputtext">
						<xsl:for-each select="SegmentRef[@ID='BEG']">
        ...
        <td align="right">
          ...
          <font color="red">
			...
			<TR>
				...
				<TD>
					<INPUT TYPE="text" name="BIG_01" Class="inputtext" SIZE="10" MAXLENGTH="10"></INPUT>
              ...
              <TD>
						<TABLE width="100%" Align="Left" Border="0" cellpadding="1" cellspacing="1">
							<TR bgcolor="#EDEDED">
								...
								<TD Align="right">
									<a onMouseOver="window.status='';return true" href="javascript:popWin('PopUp/Inv_N1.asp','EditN1Details','650','400','2')"
										id="hrefSt">[Edit]</a>
							...
							<TR>
								<TD colspan="2">
									<div id="St">
										<xsl:for-each select="N1-LOOP">
											<xsl:if test="SegmentRef[@ID='N1']/Element[(@Pos='01' $and$ @Value ='BY')]">
												<TABLE width="100%" Align="Left" Border="0" cellspacing='0' cellpadding='0'>
													<TR>
						...
						<TR>
							<TD>
								<Table Border="0" width="100%" bordercolor="black" id="DateTimeTable">
									...
									<TR>
										<TD>
											<Input type="text"  Name="DTM_01" value="011 Shipped" Class="inputText" readonly="true" style="Border-Top:0;Border-Bottom:0;Border-Left:0;Border-Right:0;"
												size="67">
												<!--<xsl:for-each select='Element[@Pos = "01"]'>
													<xsl:attribute name="value">
														<xsl:value-of select='@Value' />
										...
										<TD>
											<Input type="text" Name="DTM_02" Class="inputText" SIZE="15" maxlength="10">
                        <!--<xsl:for-each select="SegmentRef[@ID = 'DTM']">
                          <xsl:if test="Element[@Pos = '01' $and$  (@Value = '010' )]">
												<xsl:for-each select='Element[@Pos = "02"]'>
													<xsl:attribute name="value">
														<xsl:value-of select='@Value' />
													</xsl:attribute>
			...
			<TR>
				<TD>
					<Table id="ItemTable" Value="1" width="100%" align="center" border="1" style="Border-Collapse:Collapse"
						...
						<xsl:for-each select='PO1-LOOP'>
							<xsl:if test="SegmentRef[@ID = 'PO1' $and$ @DisplayInPO = 'T']">
								<TR>
									<TD id="td_Item_Detail">
										<Table width="100%" Border="0" bordercolor="black" Align="Center" cellspacing="0" Cellpadding="1"
											...
											<TR>
												<TD>
													<!--<textarea style="width:100%" name="IT1_PID_PID_05">
												...
												<TD align="right">
													<INPUT TYPE="text" style="TEXT-ALIGN: right" Class="inputtext" size="9" name="IT1_IT1_02"
														...
														<xsl:for-each select="SegmentRef[@ID='PO1']/Element[@Pos = '02']">
															<xsl:attribute name="value">
																<xsl:value-of select='@Value' />
															</xsl:attribute>
														</xsl:for-each>
													...
													<INPUT TYPE="TEXT" Class="inputtext" name="IT1_IT1_03" SIZE="3" style="text-align:center;border-bottom:0;border-top:0;border-left:0;border-right:0;"
														readonly="true">
														<xsl:for-each select="SegmentRef[@ID='PO1']/Element[@Pos = '03']">
															<xsl:attribute name="value">
																<xsl:value-of select='@Value' />
															</xsl:attribute>
														</xsl:for-each>
												...
												<TD align="center">
													<INPUT TYPE="text" name="IT1_IT1_04" style="text-align:center;border-bottom:0;border-top:0;border-left:0;border-right:0;"
														...
														<xsl:for-each select="SegmentRef[@ID='PO1']/Element[@Pos='04']">
															<xsl:attribute name="value">
																<xsl:value-of select='@Value' />
															</xsl:attribute>
														</xsl:for-each>
												...
												<TD colspan="5" ID="td_PSID_Detail">
													<Table border="0" width="100%" bordercolor="black" cellspacing="0" Cellpadding="1" style="Border-Collapse:Collapse">
														<TR BGCOLOR="#EDEDED" ID="Psid_Row">
															<xsl:choose>
																<xsl:when test="SegmentRef/Element[(@Pos = '06' $and$ @Value != '') $or$ (@Pos = '08' $and$ @Value != '') $or$ (@Pos = '10' $and$ @Value != '') $or$ (@Pos = '12' $and$ @Value != '')]">
																	<xsl:attribute name="style">display:inline</xsl:attribute>
																</xsl:when>
																<xsl:otherwise>
																	<xsl:attribute name="style">display:none</xsl:attribute>
														...
														<xsl:for-each select="SegmentRef[@ID = 'PO1']">
															<TR>
																<TD>
																	<xsl:choose>
																		<xsl:when test='Element[@Pos="06" $and$ (@Value="EN" $or$ @Value="IN"  $or$ @Value="UP" $or$ @Value="CH" $or$ @Value="LT" $or$ @Value="UK" $or$ @Value="ZZ")]'>
															...
															<TR>
																<TD>
																	<xsl:choose>
																		<xsl:when test='Element[@Pos="08" $and$ (@Value="EN" $or$ @Value="IN" $or$ @Value="UP" $or$ @Value="CH" $or$ @Value="LT" $or$ @Value="UK" $or$ @Value="ZZ")]'>
															...
															<TR>
																<TD>
																	<xsl:choose>
																		<xsl:when test='Element[@Pos="10" $and$ (@Value="EN" $or$ @Value="IN" $or$ @Value="UP" $or$ @Value="CH" $or$ @Value="LT" $or$ @Value="UK" $or$ @Value="ZZ")]'>
															...
															<TR>
																<TD>
																	<xsl:choose>
																		<xsl:when test='Element[@Pos="12" $and$ (@Value="EN" $or$ @Value="IN" $or$ @Value="UP" $or$ @Value="CH" $or$ @Value="LT" $or$ @Value="UK" $or$ @Value="ZZ")]'>
															...
															<TR>
																<TD>
																	<xsl:choose>
																		<xsl:when test='Element[@Pos="14" $and$ (@Value="EN" $or$ @Value="IN"  $or$ @Value="UP" $or$ @Value="CH" $or$ @Value="LT" $or$ @Value="UK" $or$ @Value="ZZ")]'>
															...
															<TR>
																<TD>
																	<xsl:choose>
																		<xsl:when test='Element[@Pos="16" $and$ (@Value="EN" $or$ @Value="IN"  $or$ @Value="UP" $or$ @Value="CH" $or$ @Value="LT" $or$ @Value="UK" $or$ @Value="ZZ")]'>
															...
															<TR>
																<TD>
																	<xsl:choose>
																		<xsl:when test='Element[@Pos="18" $and$ (@Value="EN" $or$ @Value="IN" $or$ @Value="UP" $or$ @Value="CH" $or$ @Value="LT" $or$ @Value="UK" $or$ @Value="ZZ")]'>
															...
															<TR>
																<TD>
																	<xsl:choose>
																		<xsl:when test='Element[@Pos="20" $and$ (@Value="EN" $or$ @Value="IN"  $or$ @Value="UP" $or$ @Value="CH" $or$ @Value="LT" $or$ @Value="UK" $or$ @Value="ZZ")]'>
                            ...
                            <TR>
																<TD>
																	<xsl:choose>
																		<xsl:when test='Element[@Pos="22" $and$ (@Value="EN" $or$ @Value="IN"  $or$ @Value="UP" $or$ @Value="CH" $or$ @Value="LT" $or$ @Value="UK" $or$ @Value="ZZ")]'>
                            ...
                            <TR>
																<TD>
																	<xsl:choose>
																		<xsl:when test='Element[@Pos="24" $and$ (@Value="EN" $or$ @Value="IN"  $or$ @Value="UP" $or$ @Value="CH" $or$ @Value="LT" $or$ @Value="UK" $or$ @Value="ZZ")]'>
																			<INPUT TYPE="text" name="IT1_IT1_24" Class="inputtext" style="text-align:left;border-bottom:0;border-top:0;border-left:0;border-right:0;"
																				size="60" readonly="true">
																				<xsl:attribute name="value">
											...
											<!--<TR>
												<TD colspan="5" ID="td_PID_Detail">
													<Table border="0" width="100%" bordercolor="black" cellspacing="0" Cellpadding="1" style="Border-Collapse:Collapse">
														...
														<TR id="pid_row_head1">
															<xsl:choose>
																<xsl:when test='PID-LOOP/SegmentRef[@ID="PID"]/Element[(@Pos="05" $and$ @Value!="")]'>
																	<xsl:attribute name="style">display:inline</xsl:attribute>
																</xsl:when>
																<xsl:otherwise>
																	<xsl:attribute name="style">display:none</xsl:attribute>
															...
															<TD colspan="4">
																<xsl:choose>
																	<xsl:when test='PID-LOOP/SegmentRef[@ID="PID"]/Element[@Pos="05" $and$ @Value!=""]'>
																		<INPUT TYPE="text" name="IT1_PID_PID_05" Class="inputtext" style="text-align:left;border-bottom:0;border-top:0;border-left:0;border-right:0;" readonly="true" size="80">
																			<xsl:attribute name="value">
																				<xsl:for-each select='PID-LOOP/SegmentRef[@ID="PID"]/Element[@Pos = "05"]'>
																					<xsl:value-of select='@Value' />
																				</xsl:for-each>
																	...
																	<xsl:otherwise>
																		<INPUT TYPE="text" Class="inputtext" name="IT1_PID_PID_05" style="display:none;text-align:left;border-bottom:0;border-top:0;border-left:0;border-right:0;" readonly="true" size="80"></INPUT>
																	</xsl:otherwise>
																</xsl:choose>
															</TD>
														</TR>
														<TR id="pid_row_head2">
															<xsl:choose>
																<xsl:when test='PID-LOOP/SegmentRef[@ID="PID"]/Element[@Pos="01" $and$ @Value!=""]'>
																	<xsl:attribute name="style">display:inline</xsl:attribute>
																</xsl:when>
																<xsl:otherwise>
																	<xsl:attribute name="style">display:none</xsl:attribute>
															...
															<TD align="left">
																<xsl:choose>
																	<xsl:when test='PID-LOOP/SegmentRef[@ID="PID"]/Element[@Pos="01" $and$ @Value!=""]'>
																		<INPUT TYPE="text" name="IT1_PID_PID_01" Class="inputtext" style="text-align:left;border-bottom:0;border-top:0;border-left:0;border-right:0;" readonly="true" size="15">
																			<xsl:attribute name="value">
																				<xsl:for-each select='PID-LOOP/SegmentRef[@ID="PID"]/Element[@Pos = "01"]'>
																					<xsl:choose>
																						<xsl:when test="@Value[value()='F']">F Free Form</xsl:when>
																					</xsl:choose>
																				</xsl:for-each>
																	...
																	<xsl:otherwise>
																		<INPUT TYPE="text" Class="inputtext" name="IT1_PID_PID_01" style="display:none;text-align:left;border-bottom:0;border-top:0;border-left:0;border-right:0;" readonly="true" size="15"></INPUT>
																	</xsl:otherwise>
																</xsl:choose>
															</TD>
														</TR>
															...
															<TD>
																<xsl:choose>
																	<xsl:when test='SAC-LOOP/SegmentRef[@ID="SAC"]/Element[@Pos="02" $and$ @Value!=""]'>
																		<INPUT TYPE="text" name="IT1_SAC_SAC_02" Class="inputtext" style="text-align:left;border-bottom:0;border-top:0;border-left:0;border-right:0;" readonly="true" size="45">
																			<xsl:attribute name="value">
															...
															<TD>
																<xsl:choose>
																	<xsl:when test='SAC-LOOP/SegmentRef[@ID="SAC"]/Element[@Pos="06" $and$ (@Value="1" $or$ @Value="2" $or$ @Value="3" $or$ @Value="4" $or$ @Value="5" $or$ @Value="6" $or$ @Value="7")]'>
																		<INPUT TYPE="text" name="IT1_SAC_SAC_06" Class="inputtext" style="text-align:left;border-bottom:0;border-top:0;border-left:0;border-right:0;" readonly="true" size="20">
																			<xsl:attribute name="value">
																				<xsl:for-each select='SAC-LOOP/SegmrntRef[@ID="SAC"]/Element[@Pos = "06"]'>
																					<xsl:choose>
															...
															<TD>
																<xsl:choose>
																	<xsl:when test='SAC-LOOP/SegmentRef[@ID="SAC"]/Element[@Pos="07" $and$ @Value!=""]'>
																		<INPUT TYPE="text" name="IT1_SAC_SAC_07" Class="inputtext" style="text-align:left;border-bottom:0;border-top:0;border-left:0;border-right:0;" readonly="true" size="6">
																			<xsl:attribute name="value">
																				<xsl:for-each select='SAC-LOOP/SegmrntRef[@ID="SAC"]/Element[@Pos = "07"]'>
																					<xsl:value-of select='@Value' />
																				</xsl:for-each>
																			</xsl:attribute>
																		</INPUT>
															...
															<TD>
																<xsl:choose>
																	<xsl:when test='SAC-LOOP/SegmentRef[@ID="SAC"]/Element[@Pos="12" $and$ (@Value="02" $or$ @Value="06")]'>
																		<INPUT TYPE="text" name="IT1_SAC_SAC_12" Class="inputtext" style="text-align:left;border-bottom:0;border-top:0;border-left:0;border-right:0;" readonly="true" size="20">
																			<xsl:attribute name="value">
																				<xsl:for-each select='SAC-LOOP/SegmrntRef[@ID="SAC"]/Element[@Pos = "12"]'>
																					<xsl:choose>
															...
															<TD align="left">
																<xsl:choose>
																	<xsl:when test='SAC-LOOP/SegmentRef[@ID="SAC"]/Element[@Pos="08" $and$ @Value!=""]'>
																		<INPUT TYPE="text" name="IT1_SAC_SAC_08" Class="inputtext" style="text-align:left;border-bottom:0;border-top:0;border-left:0;border-right:0;" readonly="true" size="10">
																			<xsl:attribute name="value">
																				<xsl:for-each select='SAC-LOOP/SegmrntRef[@ID="SAC"]/Element[@Pos = "08"]'>
																					<xsl:value-of select='@Value' />
																				</xsl:for-each>
																			</xsl:attribute>
																		</INPUT>
															...
															<TD>
																<xsl:choose>
																	<xsl:when test='SAC-LOOP/SegmentRef[@ID="SAC"]/Element[@Pos="10" $and$ @Value!=""]'>
																		<INPUT TYPE="text" name="IT1_SAC_SAC_10" Class="inputtext" style="text-align:left;border-bottom:0;border-top:0;border-left:0;border-right:0;" readonly="true" size="6">
																			<xsl:attribute name="value">
																				<xsl:for-each select='SAC-LOOP/SegmrntRef[@ID="SAC"]/Element[@Pos = "10"]'>
																					<xsl:value-of select='@Value' />
																				</xsl:for-each>
																			</xsl:attribute>
																		</INPUT>
															...
															<TD>
																<xsl:choose>
																	<xsl:when test='SAC-LOOP/SegmentRef[@ID="SAC"]/Element[@Pos="09" $and$ (@Value="CA" $or$ @Value="EA")]'>
																		<INPUT TYPE="text" name="IT1_SAC_SAC_09" Class="inputtext" style="text-align:left;border-bottom:0;border-top:0;border-left:0;border-right:0;" readonly="true" size="10">
																			<xsl:attribute name="value">
																				<xsl:for-each select='SAC-LOOP/SegmrntRef[@ID="SAC"]/Element[@Pos = "09"]'>
																					<xsl:choose>
																...
																<TR id="TR_TXI_01">
																	...
																	<TD>
																		<INPUT TYPE="text" Name="TXI_01" style="BORDER-RIGHT: 0px; BORDER-TOP: 0px; BORDER-LEFT: 0px; BORDER-BOTTOM: 0px"
																			size="45" readonly="true" Class="inputtext">
												...
												<TR id="TR_CAD_Row1">
													...
													<TD>
														<INPUT TYPE="text" Class="inputtext" style="BORDER-RIGHT: 0px; BORDER-TOP: 0px; BORDER-LEFT: 0px; BORDER-BOTTOM: 0px"
															...
															<xsl:attribute name="value">
																<xsl:for-each select="SegmentRef[@ID = 'CAD']/Element[@Pos = '01']">
																	<xsl:value-of select='@Value' />
																</xsl:for-each>
															</xsl:attribute>
														</INPUT>
